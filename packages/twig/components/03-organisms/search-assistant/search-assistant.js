...
(function (Drupal, once) {
  ...
  // Curly quotes become straight, wrapping quotes and trailing punctuation
  // are stripped, so "What is api.gov.au?" and 'cloud policy,' both match
  // their scripted query.
